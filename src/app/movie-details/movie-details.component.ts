...
import { FilmeApiService } from 'src/app/filme-api.service';
...
export class MovieDetailsComponent implements OnInit {
  ...
  constructor(private service:FilmeApiService,private router:ActivatedRoute,private title:Title,private meta:Meta) { }
